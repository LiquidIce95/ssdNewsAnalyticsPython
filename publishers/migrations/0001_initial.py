    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(db_column='publisher_name', max_length=255)),
                ('analytics', models.OneToOneField(db_column='analytics_id', on_delete=django.db.models.deletion.CASCADE, to='publishers.publisheranalytics')),
            ],
            options={
                'db_table': 'publisher',
            },
